...
let firstDayWeatherIcon=document.querySelector('.firstDayWeather .weatherIcon');
let firstDayWind=document.querySelector('.firstDayWeather .wind');
let firstDayWeatherTitle=document.querySelector('.firstDayWeather .firstDayWeatherTitle');
...
function displayFirstDayWeather(){
    ...
    firstDayWind.innerHTML=`<img src="img/icon-wind.png" class="me-1">`+apiData.current.wind_kph;
};
...
searchCity.addEventListener('click',function(){
    searchCity.style.backgroundColor='#1E202B';
})
